      ...
      <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-12">
        <div className="bg-gray-800 p-6 rounded-lg shadow-lg hover:shadow-xl transition-all duration-300 ease-in-out transform hover:scale-105 hover:border-2 hover:border-pink-500">
          <p className="text-lg mb-4">
            DP and Graphs? Used to terrify me! I'd skip problems related to them without a second thought. Then I discovered EduVerse  series. By the end, I was tackling Recursion, DP, and Graphs with confidence, even solving problems independently. Huge thanks ...
          </p>
        ...
        <div className="bg-gray-800 p-6 rounded-lg shadow-lg hover:shadow-xl transition-all duration-300 ease-in-out transform hover:scale-105 hover:border-2 hover:border-pink-500">
          <p className="text-lg mb-4">
            I was entirely new to the world of DSA and CP when I discovered EduVerse  channel. EduVerse  clear explanations ignited my passion for computer science, introducing me to core concepts like trees, graphs, and dynamic programming. Today, I stand as an ...
          </p>
          <div className="flex items-center">
